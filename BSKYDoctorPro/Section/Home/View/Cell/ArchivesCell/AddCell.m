...
@interface AddCell ()<UITableViewDelegate,UITableViewDataSource>
...
//    self.height = 100;
    ...
    [self.contentTableView registerNib:[AddSubCell nib] forCellReuseIdentifier:[AddSubCell cellIdentifier]];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell = [self.contentTableView dequeueReusableCellWithIdentifier:[AddSubCell cellIdentifier] forIndexPath:indexPath];
    AddSubCell *tableCell = (AddSubCell *)cell;
